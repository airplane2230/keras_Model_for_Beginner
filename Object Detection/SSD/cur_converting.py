...
# gt의 label_list에는 이미지에 존재하는 객체 수로 이루어져 있습니다.
...
train_keys = keys[:num_train] # 3962
val_keys = keys[num_train:] # 990
...
for i in range(BATCH_SIZE):
    ...
    label_list.append(gt[train_keys[i]])
...
image_ds = image_ds.shuffle(24)
image_ds = image_ds.batch(BATCH_SIZE)

label_ds = label_ds.shuffle(24).batch(BATCH_SIZE)
